...
import PrescribtionSteps from "../pages/prescribtion/PrescribtionSteps";
import PayingCard from "../pages/prescribtion/PayingCard";
import OnlinePrescriptionService from "../pages/prescribtion/OnlinePrescriptionService";
  ...
  <br/>
        ...
        <div className="py-10 sm:flex items-center gap-x-4">
          <div className="sm:w-1/3 flex items-center">
            ...
            Diabetes awareness, education and screening activities.
            </p>
          </div>
          <div className="sm:w-1/3 flex items-center my-5 sm:m-0">
            <AiOutlineInsurance size="30px" fill="rgb(14, 132, 147)" />
            <p className="text-xl font-poppins pl-3">Partnership with Ministry of Health, Novo Nordisk and Roche</p>
          </div>
          <div className="sm:w-1/3 flex items-center">
            <HiHome size="30px" fill="rgb(14, 132, 147)" />
            <p className="text-xl font-poppins pl-3">
            Integrating type 1 diabetes care into health systems
            </p>
          </div>
        </div>
